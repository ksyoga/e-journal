...
<!-- Content Header (Page header) -->
  ...
  <!-- Your Page Content Here -->
  		<form method="POST" action="/vehicle/{{$requist->id}}" class="form-horizontal">
				{!! csrf_field() !!}
		                  	...
		                  	<div class="box-body">
		                  		...
		                  		<div class="col-md-5">
									...
									<div class="form-group">
										...
										<textarea class="textarea" name="request_for" id="request_for" placeholder="Purpose of Vehicle" style="width: 100%; height: 120px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$requist->request_for}}</textarea>
									</div>
